    ...
    return SingleChildScrollView(
      ...
      child:Row(
        children:[
          Column(
            children:[
              const CommonShowLabelItem(),
              if(channelViewModel.selectedShowLabel == CommonShowLabel.label)
                const BottomLine(),
            ]
          ),
...
class CommonShowLabelItem extends StatelessWidget {
  const CommonShowLabelItem({super.key});
  ...
  ChannelViewModel channelViewModel = Provider.of<ChannelViewModel>(context);
    return Container(
      key:channelViewModel.getChannelCategoryGlobalKeys(CommonShowLabel.label),
      child:TextButton(
        onPressed: (){
          channelViewModel.selectedShowLabel = CommonShowLabel.label;
          Scrollable.ensureVisible(channelViewModel.getShowItemGlobalKeys(CommonShowLabel.label).currentContext!,
...
class CommonLabelIcon extends StatelessWidget {
  const CommonLabelIcon({super.key});
...
class CommonLabelName extends StatelessWidget {
  const CommonLabelName({super.key});
