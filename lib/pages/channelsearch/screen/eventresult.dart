...
import 'package:pickrewardapp/pages/channelsearch/component/criteria.cost.dart';
import 'package:pickrewardapp/pages/channelsearch/component/eventresult.result.dart';
    ...
    return Container(
      ...
      child:Stack(
        children:[
          InkWell(
            onTap:(){
              controller.animateToPage(ChannelProgressPageModel.criteria, 
