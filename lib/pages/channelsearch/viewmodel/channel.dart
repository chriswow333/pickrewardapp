...
class ChannelViewModel with ChangeNotifier {
  ...
  String _selectedShowLabel = ""; // give non exist show label
  ...
  Future<void> fetchShowLabelModels() async {
    ...
    try {
      ...
      ShowLabelsReply showLabelsReply = await ChannelRepo().channelClient.getShowLabels(EmptyReq());
      ...
      _selectedShowLabel = _showLabelModels.first.label;
...
/// Channel Labels Position
  ...
  Future<ChannelsReply> _fetchChannelsByShowLabelApi(String label, int offset, int limit) async { 
   ...
   try {
      ...
      return ChannelRepo().channelClient.getChannelsByShowLabel(showLabelReq);
    } on GrpcError catch (e) {
      logger.e(e);
    } catch (e) {
      logger.e(e);
